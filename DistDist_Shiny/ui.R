          ...
          tabsetPanel(
            ...
            tabPanel("Select Intensity Quantiles",
                     pageWithSidebar(
                       headerPanel(''),
                       sidebarPanel(
                         selectInput('quant_cell_type', 'Select cell type', "", selected = ""),
                         textInput('quantiles', 'Input quantiles', value=c(0,.25,.5,.75,1)),
            ...
            tabPanel("Select Distance",
                     pageWithSidebar(
                       ...
                       sidebarPanel(
                         ...
                         selectInput('dist_metric', 'Select distance metric', c("JSD","KLD"), selected = "JSD")
                       ),
                       mainPanel(
